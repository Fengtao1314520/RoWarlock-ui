<template>
  <div>
    ...
    <section class="section is-main-section">
      <view-project :projectname="projectname" :projectindex="0" />
    </section>
  </div>
</template>
  ...
  methods: {
    ...
    titleStack() {
      if (this.defalutprojs.length === 0) {
        this.defaultname = '预展示第一个项目'
        this.projectname = null
      } else {
        this.defaultname = this.defalutprojs[0].name
        this.projectname = this.defalutprojs[0].to
      }
